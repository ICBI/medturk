...
module.exports = {
	...
	bulk_answer: function(_phrase_id, _answer, _answer_type, _frequency, _user_id, _callback, _error_callback, _passthrough) {
		...
		if (_frequency == 'once') {
			bulk_answer_once(_phrase_id, _answer, _answer_type, _user_id, bulk_answer_callback, bulk_answer_error_callback)
		}
		else if(_frequency == 'multiple') {
			bulk_answer_multiple(_phrase_id, _answer, _answer_type, _user_id, bulk_answer_callback, bulk_answer_error_callback)
		}
		else {
...
function bulk_answer_multiple(_phrase_id, _answer, _answer_type, _user_id, _callback, _error_callback) {
	...
	hit.get_hits_by_phrase_id(_phrase_id, get_hits_callback, get_hits_callback_error)
}
...
function bulk_answer_once(_phrase_id, _answer, _answer_type, _user_id, _callback, _error_callback) {
	/*
...
function get_hits_by_phrase_id(_phrase_id, _callback, _error_callback) {

	var _query        = {'annotations' : {$elemMatch : { 'phrase_ids' : _phrase_id}}}	

	db.collection('hits').find(_query, _update_query, _flags, function(err, result) {
		if (err) {
			_error_callback(err)
		}
		else {
